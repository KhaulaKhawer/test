...
# TASK 2.1: Set the title of the dashboard
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = rec_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()                 
        R_chart2  = dcc.Graph(figure=px.bar(average_sales, x='Vehicle_Type', y='Automobile_Sales',
            			title="Average Number of Vehicles Sold by Vehice Type"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        R_chart4 = dcc.Graph(figure=px.bar(unemp_data, x='unemployment_rate', 
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata, x='Year', y='Automobile_Sales',
                    title='Average No. of Vehicles Sold during the given Year {}'.format(input_year)))
